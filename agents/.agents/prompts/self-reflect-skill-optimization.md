...
Do self-reflection on this session:
- Use the skill-creator, tokenscope skills.
- Evaluate the session and optimize all skills utilized.
...
- Optimize by reducing the number of tool calls by the agent and sub-agents.
