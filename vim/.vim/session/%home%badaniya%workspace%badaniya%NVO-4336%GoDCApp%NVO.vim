...
let Bufferline__session_restore = "lua require('barbar.state').restore_buffers { { name = \"~/workspace/badaniya/NVO-4336/GoDCApp/NVO/Test/src/test/network/functional/usecase/device_onboarding_test.go\" } }"
...
badd +382 Test/src/test/network/functional/usecase/device_onboarding_test.go
argglobal
%argdel
...
silent! normal! zE
let &fdl = &fdl
let s:l = 382 - ((46 * winheight(0) + 30) / 61)
