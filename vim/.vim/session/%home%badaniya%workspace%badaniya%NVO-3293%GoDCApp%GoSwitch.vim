...
let Bufferline__session_restore = "lua require('barbar.state').restore_buffers { { name = \"RunOnce/src/runonce/main.go\" } }"
...
badd +61 RunOnce/src/runonce/main.go
argglobal
%argdel
edit RunOnce/src/runonce/main.go
wincmd t
