...
/**
 * No-op factory function to make this a valid pi extension.
 * This package only provides types and is consumed by other extensions via npm.
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export default function createExtension(_pi: unknown): void {
	// This package only exports types - no extension functionality needed
}
