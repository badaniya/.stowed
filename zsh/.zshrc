...
[[ $TERM == "xterm-ghostty" ]] && export TERM=xterm-256color # Do not override tmux-256color if set (tmux-256color is needed for nvim snacks.image to render images properly)
